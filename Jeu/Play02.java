...
public class Play02 {
    public static void main(String[] args) {
        ...
        while (guerrier.estVivant() && mage.estVivant() && voleur.estVivant()) {
            System.out.println("\n--- Tour de combat ---");
            System.out.println("Guerrier "+guerrier.getNom()+" A "+guerrier.getPointsdeVie());
            System.out.println("Mage: "+mage.getNom()+" A "+mage.getPointsdeVie());
            System.out.println("Voleur:"+voleur.getNom()+" A "+voleur.getPointsdeVie());
